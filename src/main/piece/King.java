...
public class King extends Piece {
	...
	public void setCheck(final CheckState state) {
		...
		Chess.logger.info(String.format("Setting %s King.check to %s", this.color.name(), state.name()));
		this.check = state;
	}
	...
	public void setKingside(final boolean bool) {
		Chess.logger.info(String.format("Setting %s King.king to %b", this.color.name(), bool));
		this.king = bool;
	}
